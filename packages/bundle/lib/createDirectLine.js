...
var cov_1lqj7rxk5q = (function() {
  var path = '/home/guy/leo/BotFramework-WebChat/packages/bundle/src/createDirectLine.js';
  var hash = 'bf2fe8e2ede54aa6dffd7b3cfd5e04890ba470a0';
  var global = new Function('return this')();
  var gcv = '__coverage__';
  var coverageData = {
    path: '/home/guy/leo/BotFramework-WebChat/packages/bundle/src/createDirectLine.js',
    statementMap: {
      '0': {
        start: {
          line: 15,
    ...
    hash: 'bf2fe8e2ede54aa6dffd7b3cfd5e04890ba470a0'
  };
...
function createDirectLine(_ref) {
  ...
  return new _botframeworkDirectlinejs.DirectLine({
    ...
    createFormData: function createFormData(attachments) {
      cov_1lqj7rxk5q.f[1]++;
      var formData = (cov_1lqj7rxk5q.s[1]++, new FormData());
      cov_1lqj7rxk5q.s[2]++;
