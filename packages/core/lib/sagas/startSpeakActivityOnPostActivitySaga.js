...
var cov_fv4hljalg = (function() {
  var path =
    '/Users/guy/Work/Leo/leo/BotFramework-WebChat/packages/core/src/sagas/startSpeakActivityOnPostActivitySaga.js';
  var hash = 'e50c97631ea2fd5c55ce2a42cafc8310d6947663';
  ...
  var coverageData = {
    ...
    hash: 'e50c97631ea2fd5c55ce2a42cafc8310d6947663'
  };
        ...
        case 0:
          ...
          return (0, _effects.takeEvery)(
            function(_ref) {
              ...
              cov_fv4hljalg.s[1]++;
              return (
                (cov_fv4hljalg.b[0][0]++, type === _postActivity.POST_ACTIVITY_PENDING) &&
                (cov_fv4hljalg.b[0][1]++, meta.method === 'speech') &&
                (cov_fv4hljalg.b[0][2]++, payload.activity.type === 'message')
              );
            },
            /*#__PURE__*/
