...
var cov_1c2qwuwtj8 = (function() {
  var path = '/home/guy/leo/BotFramework-WebChat/packages/core/src/reducers/referenceGrammarID.js';
  var hash = 'e6e1fcebf8be2855c0d860e22cd03fa150c70c8e';
  var global = new Function('return this')();
  var gcv = '__coverage__';
  var coverageData = {
    path: '/home/guy/leo/BotFramework-WebChat/packages/core/src/reducers/referenceGrammarID.js',
    statementMap: {
      '0': {
        start: {
          line: 3,
    ...
    hash: 'e6e1fcebf8be2855c0d860e22cd03fa150c70c8e'
  };
...
var DEFAULT_STATE = (cov_1c2qwuwtj8.s[0]++, null);

function referenceGrammarID() {
  var state =
    arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (cov_1c2qwuwtj8.b[0][0]++, DEFAULT_STATE);
  ...
  switch (type) {
    case _setReferenceGrammarID.SET_REFERENCE_GRAMMAR_ID:
      cov_1c2qwuwtj8.b[1][0]++;
      cov_1c2qwuwtj8.s[2]++;
      state = (cov_1c2qwuwtj8.b[2][0]++, payload.referenceGrammarID) || (cov_1c2qwuwtj8.b[2][1]++, null);
      cov_1c2qwuwtj8.s[3]++;
      break;

    default:
      cov_1c2qwuwtj8.b[1][1]++;
      cov_1c2qwuwtj8.s[4]++;
      break;
  }
