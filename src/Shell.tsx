...
class ShellContainer extends React.Component<Props> implements ShellFunctions {
    ...
    render() {
        ...
        return (
            <div className={ className } style={{ display: this.props.connectionStatus !== ConnectionStatus.Online ? 'none' : 'block' }}>
                { this.props.showUploadButton &&
                    ...
                    <svg>
                        <path d={this.props.icons.upload.svg}/>
                    </svg>
                    }
                ...
                <button
                    ...
                    type="button"
                >
                { !!this.props.icons.send.svg && <svg><path d={this.props.icons.send.svg} /></svg> }
                { !!this.props.icons.send.base64 && <img src={this.props.icons.send.base64} /> }
                </button>
                <button
